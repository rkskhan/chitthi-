...
export const DEFAULT_LETTER: LetterData = {
  ...
  salutation: 'আমার প্রাণের অর্ধাঙ্গিনী,',
  paragraphs: [
    'আজ চিঠি দিবস। ডিজিটাল এই যুগে আজ না হয় এই ডিজিটাল কালির আঁচড়েই মনের কিছু না-বলা কথা তোমার কাছে পাঠালাম।',
    'তুমি বাবার বাড়ি গিয়েছ মাত্র ক\'টা দিন হলো, অথচ আমার কাছে এই এক একটা দিন যেন একশ দিনের সমান মনে হচ্ছে। তুমিহীন এই ঘর বড্ড নিস্তব্ধ, সময় যেন এখানে এসে থমকে দাঁড়িয়েছে।',
    'তোমার ওপর আমার খুব অভিমান হয়, জানো? মাঝে মাঝে বড্ড রাগ হয় এই ভেবে যে, এত কাছে থেকেও তুমি আজও আমাকে ঠিকমতো বুঝে উঠতে পারলে না। আমার মনের গভীরের না-বলা কথাগুলো, আমার অনুভূতিগুলো আজও তোমার কাছে কেমন যেন অচেনা রয়ে গেল।',
    'কিন্তু কী আশ্চর্য দেখো, এই তীব্র অভিমানের চেয়েও তোমাকে কাছে না পাওয়ার কষ্টটা অনেক বেশি। তুমি দূরে আছো বলেই হয়তো আরও বেশি করে বুঝতে পারছি, তোমায় ছাড়া আমার অস্তিত্ব কতটা অসম্পূর্ণ। আমার সব রাগ, সব অভিযোগ কেবল তোমার ওই মুখখানি দেখার অপেক্ষায় মুহূর্তেই হার মেনে যায়।',
    'আর দূরত্ব বাড়িও না, তাড়াতাড়ি ফিরে এসো আমার কাছে। তোমার অপেক্ষায় আমার প্রতিটি প্রহর যেন অনন্তকাল হয়ে দাঁড়িয়েছে।'
  ],
  signOff: 'ইতি তোমার,',
  signatureName: 'সাগর',
  ...
  receiverName: 'সামিয়া খান',
  receiverAddress: 'মিয়াজী বাড়ি, দরুন বাজার, সাচরা, বোরহানউদ্দিন, ভোলা-৮৩২০',
  theme: 'classic',
  stampType: 'star',
